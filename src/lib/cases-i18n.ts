...
export function getLocalizedCase(caseStudy: CaseStudy, lang: Language) {
  return {
    ...
    products: (getCaseField(caseStudy, 'products', lang) || getCaseField(caseStudy, 'productsEn', lang)) as string[],
    challenge: getCaseField(caseStudy, 'challenge', lang) as string,
    solution: getCaseField(caseStudy, 'solution', lang) as string,
    results: (getCaseField(caseStudy, 'results', lang) || getCaseField(caseStudy, 'resultsEn', lang)) as string[],
    testimonial: (getCaseField(caseStudy, 'testimonial', lang) || getCaseField(caseStudy, 'testimonialEn', lang)) as string | undefined,
    clientName: (getCaseField(caseStudy, 'clientName', lang) || getCaseField(caseStudy, 'clientNameEn', lang)) as string | undefined,
    clientPosition: (getCaseField(caseStudy, 'clientPosition', lang) || getCaseField(caseStudy, 'clientPositionEn', lang)) as string | undefined,
