...
export const products: Product[] = [
  // ==================== 防护服系列 ====================
  {
    id: '3015',
    name: '连体式防护服',
    nameEn: 'One-Piece Protective Suit',
    ...
    description: '连体式防护服，采用优质PVC材料制作，具有良好的防水、防尘、防油污性能。适合化工、喷涂、清洁等作业环境。',
    descriptionEn: 'One-piece protective suit made of high-quality PVC material. Features excellent water, dust, and oil resistance. Suitable for chemical, spraying, and cleaning operations.',
    features: [
      '连体设计',
      '防水防尘',
      '耐用材质',
    ...
    applications: ['化工行业', '喷涂作业', '清洁作业', '粉尘环境'],
    applicationsEn: ['Chemical industry', 'Spraying operations', 'Cleaning work', 'Dusty environments'],
    color: '多色可选',
    material: 'PVC复合材料',
  },
  {
